...
const SearchSection = (): JSX.Element => {
  ...
  return (
    <section className='w-full h-auto mb-5 flex flex-col justify-center items-center'>
      <div className='w-full h-auto flex flex-col justify-center items-center gap-1 mb-2'>
        <span className='text-[0.5rem] self-start text-gray-3 mb-1'>Total Pokémons available: {pokemonNames?.count}</span>
