...
const CreditsModal = ({ isVisible, setOpenCreditsModal }: CreditsModalProps): JSX.Element => {
  return (
    <section className={`absolute inset-0 w-full min-h-screen bg-transparent p-3 flex flex-col justify-center items-center backdrop-blur-xl ${isVisible ? 'block' : 'hidden'}`}>
        <div className='bg-black w-full sm:max-w-[30rem] h-auto p-3 flex flex-col justify-center items-center rounded-lg drop-shadow-2xl drop-shadow-gray-3'>
            <button 
            ...
            <div className='w-full flex flex-col justify-center items-start gap-y-3 [&>h3]:mb-0!'>
                <h3>About</h3>
                <p>Pokéfetch is a chill React + TypeScript app that taps into the PokéAPI to pull in Pokémon info on the fly. Just search for a Pokémon, and boom — you get a clean, minimal card showing the essentials. No clutter, no chaos, just straight vibes and Pokédex energy.</p>
